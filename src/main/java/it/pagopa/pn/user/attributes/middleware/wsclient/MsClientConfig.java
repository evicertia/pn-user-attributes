...
public class MsClientConfig  extends CommonBaseClient {
    ...
    EvinoticeApi eviNoticeApi(PnUserattributesConfig pnUserattributesConfig) {
        it.pagopa.pn.user.attributes.user.attributes.generated.openapi.msclient.evinotice.v2.ApiClient apiClient = new it.pagopa.pn.user.attributes.user.attributes.generated.openapi.msclient.evinotice.v2.ApiClient(initWebClient(it.pagopa.pn.user.attributes.user.attributes.generated.openapi.msclient.evinotice.v2.ApiClient.buildWebClientBuilder()));
        apiClient.setBasePath(pnUserattributesConfig.getClientEviNoticeBasepath());
        apiClient.setUsername(pnUserattributesConfig.getClientEviNoticeUserName());
        apiClient.setPassword(pnUserattributesConfig.getClientEviNoticePass());

        // TODO Set Certificate Authentication to send QERDS EN

        return new EvinoticeApi(apiClient);
    }
